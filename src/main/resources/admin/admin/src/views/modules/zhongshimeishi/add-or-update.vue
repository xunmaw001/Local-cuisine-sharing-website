  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="菜品类型" prop="caipinleixing">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="烹饪方法" prop="pengrenfangfa">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.pengrenfangfa" label="烹饪方法" prop="pengrenfangfa">
                    <span v-html="ruleForm.pengrenfangfa"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="美食的由来" prop="meishideyoulai">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.meishideyoulai" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.meishideyoulai" label="美食的由来" prop="meishideyoulai">
                    <span v-html="ruleForm.meishideyoulai"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pengrenfangfa = true;
          ...
          if(o=='meishideyoulai'){
            this.ruleForm.meishideyoulai = obj[o];
	    this.ro.meishideyoulai = true;
            continue;
          }
          if(o=='pingfen'){
	...
	this.ruleForm.pengrenfangfa = this.ruleForm.pengrenfangfa.replace(reg,'../../../springbooth10zf/upload');
	this.ruleForm.meishideyoulai = this.ruleForm.meishideyoulai.replace(reg,'../../../springbooth10zf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhongshimeishi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhongshimeishiCrossAddOrUpdateFlag = false;
						 this.parent.search();
